...
protected:
	...
	static void init_code_map()
	{
		...
		m_code_map["CLR" ] = SCommand(Code::CLRW,  Type::Unicast);
		m_code_map["INC" ] = SCommand(Code::INCW,  Type::Unicast);
		m_code_map["DEC" ] = SCommand(Code::DECW,  Type::Unicast);
		m_code_map["COM" ] = SCommand(Code::COMW,  Type::Unicast);
		m_code_map["TST" ] = SCommand(Code::TSTW,  Type::Unicast);
		m_code_map["NEG" ] = SCommand(Code::NEGW,  Type::Unicast);
		m_code_map["ASR" ] = SCommand(Code::ASRW,  Type::Unicast);
		m_code_map["ASL" ] = SCommand(Code::ASLW,  Type::Unicast);
		m_code_map["ROR" ] = SCommand(Code::RORW,  Type::Unicast);
		m_code_map["ROL" ] = SCommand(Code::ROLW,  Type::Unicast);
		m_code_map["ADC" ] = SCommand(Code::ADCW,  Type::Unicast);
		m_code_map["SBC" ] = SCommand(Code::SBCW,  Type::Unicast);
		...
		m_code_map["MOV" ] = SCommand(Code::MOVW,  Type::Dubcast);
		m_code_map["CMP" ] = SCommand(Code::CMPW,  Type::Dubcast);
		m_code_map["BIT" ] = SCommand(Code::BITW,  Type::Dubcast);
		m_code_map["BIC" ] = SCommand(Code::BICW,  Type::Dubcast);
		m_code_map["BIS" ] = SCommand(Code::BISW,  Type::Dubcast);
